...
define Device/dnzo-wrt_3c
  IMAGE_SIZE := 15104k
  DEVICE_VENDOR := DnZO wrt
  DEVICE_MODEL := 3C
  DEVICE_PACKAGES := uboot-envtools
endef
TARGET_DEVICES += dnzo-wrt_3c

define Device/dnzo-wrt_4a-basic
  IMAGE_SIZE := 14976k
  DEVICE_VENDOR := DnZO wrt
  DEVICE_MODEL := 4A Basic
  DEVICE_PACKAGES := kmod-mt76x2
  SUPPORTED_DEVICES += dnzo-wrt,4a-basic
endef
TARGET_DEVICES += dnzo-wrt_4a-basic

define Device/dnzo-wrt_4c
  IMAGE_SIZE := 14976k
  DEVICE_VENDOR := DnZO wrt
  DEVICE_MODEL := 4C
  DEVICE_PACKAGES := uboot-envtools
endef
TARGET_DEVICES += dnzo-wrt_4c
